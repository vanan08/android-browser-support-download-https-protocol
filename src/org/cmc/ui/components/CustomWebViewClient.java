...
//		view.loadUrl("javascript:document.body.innerHTML = document.body.innerHTML.replace(/intent:#Intent;action=com.cmc.downloadmanager.DOWNLOAD_ACTION;S.link=/gi,'');");
//		view.loadUrl("javascript:document.body.innerHTML = document.body.innerHTML.replace(/;end/gi,'');");
	}
	...
	public void onPageStarted(WebView view, String url, Bitmap favicon) {
		...
		((MainActivity)view.getContext()).setToolbarsVisibility(true);
	...
	public boolean shouldOverrideUrlLoading(WebView view, String url) {
		...
		if(url.contains("com.cmc.downloadmanager.DOWNLOAD_ACTION")){
			url = url.replaceAll("intent:#Intent;action=com.cmc.downloadmanager.DOWNLOAD_ACTION;S.link=", "");
			url = url.replaceAll(";end", "");
			view.loadUrl(url);
			return true;
//			Log.i(CustomWebViewClient.class.getSimpleName(),
//					"resetLoadedUrl");
...
//			return false;
		...
		if (isExternalApplicationUrl(url)) {
			...
			Log.i(CustomWebViewClient.class.getSimpleName(), "EMAIL_TYPE");
